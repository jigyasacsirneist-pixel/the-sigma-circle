...
const DEFAULT_WORDS = ["MATHS", "π ∞ Σ", "EXPLORE", "DISCOVER", "CSIR-NEIST"]
...
export function ParticleTextEffect({ words = DEFAULT_WORDS, className }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    // Gold-themed colors for the maths club
    const goldColors = [
      { r: 255, g: 204, b: 0 },   // Gold
      { r: 255, g: 215, b: 100 }, // Light gold
      { r: 218, g: 165, b: 32 },  // Goldenrod
      { r: 255, g: 255, b: 255 }, // White
    ]
    const newColor = goldColors[Math.floor(Math.random() * goldColors.length)]
